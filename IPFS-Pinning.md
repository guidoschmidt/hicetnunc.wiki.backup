Your OBJKTs are uploaded by H=N "off-chain" to The Interplanetary File System, or [IPFS](https://www.ipfs.com/). The Tezos contract stores the references to the IPFS hash of the art and to other metadata like title and description.
